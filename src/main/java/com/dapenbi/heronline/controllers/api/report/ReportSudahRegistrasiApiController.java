...
@RestController
public class ReportSudahRegistrasiApiController {
    private DataSource dataSource;

    public ReportSudahRegistrasiApiController(DataSource dataSource){
        this.dataSource = dataSource;
    }

    @GetMapping(Prefix.PATH_API+Prefix.PATH_REPORT+Prefix.PATH_SUDAH_HER+"/report-her")
