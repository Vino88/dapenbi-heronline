...
@RestController
public class GeneratePasswordApiController {
    @GetMapping(Prefix.PATH_API+Prefix.PATH_GENERATE_PASSWORD)
    ...
    public String generatePassayPassword() {
        ...
        CharacterRule splCharRule = new CharacterRule(digitChars);
        splCharRule.setNumberOfCharacters(1);
        String password = gen.generatePassword(6, splCharRule, lowerCaseRule, upperCaseRule, digitRule);
        return password;
    }
